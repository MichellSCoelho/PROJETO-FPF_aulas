...
class GerenciadorHotel:
    def __init__(self):
        self.listaClientes = [
            Cliente('Jonatas', 25, '12345678901', 1000, 3),
            Cliente('Maria', 22, '98765432110', 50000, 10),
            Cliente('Fernando', 30, '123445678901', 100, 5)
        ]
    ...
    def criarCliente(self):
        ...
        dias = int(input('Quantos dias deseja estadia? '))
...
while True:
    ...
    try:
        escolha = int(input('1-Criar | 2-Buscar | 3-Listar | 4-Check-in/Check-out | 5-Deletar | 6-Sair: '))
        match escolha:
